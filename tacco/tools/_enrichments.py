...
def get_contributions(
    ...
    counts_location
        ...
        :func:`~tc.get.counts`. The counts are only used if `reads` is `True`.
...
def enrichments(
    ...
    if method == 'fisher':
        ...
        test_method = lambda c: fishers_exact(c, alternative=alternative)
        ...
        test_method = lambda c: mannwhitneyu(c, alternative=alternative)
        ...
        test_method = lambda c: studentttest(c, alternative=alternative, n_boot=n_boot)
        ...
        test_method = lambda c: welchttest(c, alternative=alternative, n_boot=n_boot)
